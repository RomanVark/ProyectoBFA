...
- Crea la clase de la acción en el paquete `ni.edu.uam.BFA.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="ni.edu.uam.BFA.acciones.MostrarImporte"/>
</controlador>
```

```java
package ni.edu.uam.BFA.acciones;
...
- ✅ Coloca las clases de acción en `ni.edu.uam.BFA.acciones`
...
```java
package ni.edu.uam.BFA.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `ni.edu.uam.BFA.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
